...
class RDSTopo( Topo ):
    ...
    def build( self ):
       ...
       # Criação de Utilizadores e Switch
        ...
        "*** Criação do Controlador a fim de ser chamado nos Switchs da Topologia\n"
        
        c1 = net.addController( 's1', port=6633 )
        c2 = net.addController( 's2', port=6634 )
        c3 = net.addController( 's3', port=6635 )
        c4 = net.addController( 's4', port=6636 )
