...
def topo():
       ...
       # Adição de Switchs
        ...
        r1 = net.addSwitch( 'r1_A', dpid='0000000000000001', protocols='OpenFlow13') # Switch/Router Principal de Layer3 Rede A
        r2 = net.addSwitch( 'r2_B', dpid='0000000000000005', protocols='OpenFlow13') # Switch/Router Principal de Layer3 Rede B
        r3 = net.addSwitch( 'r3_C', dpid='0000000000000006', protocols='OpenFlow13') # Switch/Router Principal de Layer3 Rede C
	...
	# Criação de Utilizadores com respetivo ip e Switchs de Layer 3 e Layer 2
        ...
        net.addLink ( r1, s2) # Ligação Switch/Router layer 3 com Switch Layer 2 Rede A
        net.addLink ( r2, s3 ) # Ligação Switch/Router layer 3 com Switch Layer 2 Rede B
        net.addLink ( r2, s4 ) # Ligação Switch/Router layer 3 com Switch Layer 2 Rede C
